...
Think you know an algorithm that can pinpoint the $CATE$ even in the hard case? You can write them in the comments below, or feel free to use the [code](https://github.com/IyarLin/blog-code/blob/master/content/blog/causal-inference-bake-off-kaggle-style.Rmd) that produced this post to add them to the competition. 